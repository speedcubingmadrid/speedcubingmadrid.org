class NotificationMailer < ApplicationMailer
  ...
  def notify_of_new_competition
    ...
    mail(to: "notificaciones-socios@speedcubingmadrid.org", subject: "[AMS] La competición #{@competition.name} se acaba de anunciar", from: "notificaciones@speedcubingmadrid.org", reply_to: "contacto@speedcubingmadrid.org")
  end
